# Slider Perfecto (WebGL Slider Effects)

![Project Preview](img/preview.jpg)

## Description
A high-performance, interactive image slider built with WebGL and GSAP. This project demonstrates advanced visual effects and smooth transitions between slides, creating a highly engaging and modern user experience. It leverages WebGL for rendering complex effects and GSAP for fluid animations.
...
- **Customizable Settings:** Toggleable settings menu (Press 'H') to adjust visual parameters.
